            ...
            <form action="{{ route('layanan-surat.submit', $type) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="nik" class="block text-sm font-medium text-gray-700">
                                NIK Pelapor (Nomor Induk Kependudukan) *
                            </label>
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <!-- NIK Almarhum -->
                        <div>
                            <label for="nik_almarhum" class="block text-sm font-medium text-gray-700">
                            ...
                            <input type="text" name="nik_almarhum" id="nik_almarhum"
                                ...
                                placeholder="Masukkan 16 digit NIK almarhum sesuai KTP"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">
                            <p class="mt-1 text-xs text-gray-500">
                                Contoh: 3313110905810002 (16 digit angka sesuai KTP almarhum)
                            </p>
                            @error('nik_almarhum')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
    ...
    @push('scripts')
        <script>
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                const nikAlmarhumInput = document.getElementById('nik_almarhum');
                ...
                if (nikAlmarhumInput) {
                    nikAlmarhumInput.addEventListener('input', function() {
                        validateNIKAlmarhum(this);
                    });
                }
            });
        </script>
