            ...
            <form action="{{ route('layanan-surat.submit', $type) }}" method="POST"
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <!-- Jenis Hiburan -->
                        <div>
                            <label for="jenis_hiburan" class="block text-sm font-medium text-gray-700">Jenis Hiburan
                                *</label>
                        ...
                        <!-- Tempat Acara -->
                        <div>
                            <label for="tempat_acara" class="block text-sm font-medium text-gray-700">Tempat Acara
                                *</label>
                        ...
                        <!-- Hari Acara -->
                        <div>
                            <label for="hari_acara" class="block text-sm font-medium text-gray-700">Hari Acara
                                *</label>
                        ...
                        <!-- Tanggal Acara -->
                        <div>
                            <label for="tanggal_acara" class="block text-sm font-medium text-gray-700">Tanggal Acara
                                *</label>
                        ...
                        <!-- Jumlah Undangan -->
                        <div>
                            <label for="jumlah_undangan" class="block text-sm font-medium text-gray-700">Jumlah
                                Undangan *</label>
