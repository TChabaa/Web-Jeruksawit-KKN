    ...
    <section class="px-6 mx-auto py-30 max-w-7xl font-inter">
        <div class="mb-10 text-center">
            ...
            <p class="max-w-3xl mx-auto text-gray-600">
                Silakan pilih jenis surat yang Anda butuhkan di bawah ini. Setiap jenis surat akan meminta beberapa informasi dasar dan dokumen
                pendukung yang diperlukan. Setelah mengisi formulir, surat akan langsung ke email anda sesuai format untuk kemudian bisa dikirimkan ke
                Pemerintah Desa Jeruksawit untuk diproses. Proses ini akan membantu Anda mendapatkan surat yang diperlukan dengan cepat dan mudah.
            </p>
        </div>
