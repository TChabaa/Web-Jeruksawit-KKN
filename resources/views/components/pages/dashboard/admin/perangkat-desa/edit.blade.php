<x-layouts.dashboard>
    <x-slot:title>Ubah Perangkat Desa | </x-slot:title>
    ...
    <nav class="mb-5">
        <ol class="flex items-center gap-2">
            ...
            <li class="font-medium text-primary">Ubah Perangkat Desa</li>
        </ol>
    </nav>

    <form action="{{ route(auth()->user()->role . '.perangkat-desa.update', $perangkat_desa->id_perangkat) }}"
        ...
        <div class="form-1">
            <div class="">
                <h1 class="mb-6 text-xl font-bold text-black-dashboard dark:text-white-dahsboard">Ubah Perangkat Desa
                </h1>
            </div>
            ...
            <div class="px-6 py-6 mb-6 bg-white rounded-lg shadow-lg dark:bg-black">
                ...
                @if ($perangkat_desa->gambar)
                    <div class="mt-3 mb-3">
                        <p class="text-sm font-medium text-gray-600 dark:text-gray-300 mb-2">Foto saat ini:</p>
                        <img src="{{ Storage::url($perangkat_desa->gambar) }}" alt="Foto {{ $perangkat_desa->nama }}"
            ...
            <div class="px-6 py-6 mb-6 bg-white rounded-lg shadow-lg dark:bg-black">
                <div class="mb-4.5">
                    ...
                    <input type="text" required name="nama" autocomplete="nama" maxlength="255"
                        placeholder="Masukan Nama Lengkap" value="{{ old('nama', $perangkat_desa->nama) }}"
                ...
                <div class="mb-4.5">
                    ...
                    <input type="text" required name="jabatan" autocomplete="jabatan" maxlength="255"
                        placeholder="Masukan Jabatan" value="{{ old('jabatan', $perangkat_desa->jabatan) }}"
                        class="w-full rounded border-[1.5px] border-stroke bg-transparent px-5 py-3 font-normal text-black-dashboard outline-none transition focus:border-primary active:border-primary disabled:cursor-default disabled:bg-whiter dark:border-form-strokedark dark:bg-form-input dark:text-white-dahsboard dark:focus:border-primary" />
