    ...
    <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <form action="{{ route(auth()->user()->role . '.layanan-surat.submit', $type) }}" method="POST"
                ...
                <!-- Detail Kelahiran Section -->
                <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-600">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Detail Kelahiran</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Informasi khusus tentang bayi yang dilahirkan</p>
                </div>
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Nama Anak -->
                        <div>
                            <label for="nama_anak" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama Anak *</label>
                        ...
                        <!-- Jenis Kelamin Anak -->
                        <div>
                            <label for="jenis_kelamin_anak" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Jenis
                                Kelamin Anak *</label>
                        ...
                        <!-- Hari Lahir -->
                        <div>
                            <label for="hari_lahir" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Hari Lahir
                                *</label>
                        ...
                        <!-- Tanggal Lahir Anak -->
                        <div>
                            <label for="tanggal_lahir_anak" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Tanggal
                                Lahir Anak *</label>
                        ...
                        <!-- Tempat Lahir Anak -->
                        <div>
                            <label for="tempat_lahir_anak" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Tempat
                                Lahir Anak *</label>
                        ...
                        <!-- Penolong Kelahiran -->
                        <div>
                            <label for="penolong_kelahiran" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Penolong
                                Kelahiran *</label>
                        ...
                        <!-- Ibu Kandung -->
                        <div>
                            <label for="ibu" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama Ibu Kandung *</label>
                        ...
                        <!-- Ayah Kandung -->
                        <div>
                            <label for="ayah" class="block text-sm font-medium text-gray-700 dark:text-gray-200">  Nama Ayah Kandung *</label>
