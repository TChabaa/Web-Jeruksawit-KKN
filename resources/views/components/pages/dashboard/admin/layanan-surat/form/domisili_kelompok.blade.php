                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="nama_kelompok" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama
                        ...
                        <!-- Alamat Kelompok -->
                        <div class="sm:col-span-2">
                            <label for="alamat_kelompok" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Alamat
                                Kelompok *</label>
                            <textarea name="alamat_kelompok" id="alamat_kelompok" rows="3" required
                                ...
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('alamat_kelompok') }}</textarea>
                        ...
                        <!-- Ketua -->
                        <div>
                            <label for="ketua" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama Ketua *</label>
                        ...
                        <!-- Email Ketua -->
                        <div>
                            <label for="email_ketua" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Email Ketua
                                *</label>
                        ...
                        <!-- Sekretaris -->
                        <div>
                            <label for="sekretaris" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama Sekretaris
                                *</label>
                        ...
                        <!-- Bendahara -->
                        <div>
                            <label for="bendahara" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama Bendahara
                                *</label>
