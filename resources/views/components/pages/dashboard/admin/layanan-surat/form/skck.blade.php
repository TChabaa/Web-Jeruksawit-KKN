        ...
        <div class="bg-white shadow rounded-lg">
            <form action="{{ route(auth()->user()->role . '.layanan-surat.submit', $type) }}" method="POST"
                ...
                <div class="px-6 py-4 border-t border-gray-200">
                    <h3 class="text-lg font-medium text-gray-900">Detail SKCK</h3>
                    <p class="mt-1 text-sm text-gray-500">Informasi khusus untuk permohonan SKCK</p>
                </div>
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            <label for="tanggal_mulai_berlaku" class="block text-sm font-medium text-gray-700">Tanggal
                                Mulai Berlaku *</label>
                        ...
                        <div>
                            <label for="tanggal_akhir_berlaku" class="block text-sm font-medium text-gray-700">Tanggal
                                Akhir Berlaku *</label>
