            ...
            <form action="{{ route(auth()->user()->role . '.layanan-surat.submit', $type) }}" method="POST"
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Mulai Usaha -->
                        <div>
                            <label for="mulai_usaha" class="block text-sm font-medium text-gray-700">Tanggal Mulai
                                Usaha *</label>
                        ...
                        <!-- Jenis Usaha -->
                        <div>
                            <label for="jenis_usaha" class="block text-sm font-medium text-gray-700">Jenis Usaha
                                *</label>
                        ...
                        <div class="sm:col-span-2">
                            <label for="alamat_usaha" class="block text-sm font-medium text-gray-700">Alamat Usaha
                                *</label>
                            <textarea name="alamat_usaha" id="alamat_usaha" rows="3" required
                                placeholder="Alamat lengkap tempat usaha beroperasi"
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">{{ old('alamat_usaha') }}</textarea>
                            @error('alamat_usaha')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
