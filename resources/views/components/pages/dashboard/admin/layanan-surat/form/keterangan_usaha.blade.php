    ...
    <div class="px-4 py-6 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <form action="{{ route(auth()->user()->role . '.layanan-surat.submit', $type) }}" method="POST"
                ...
                <!-- Detail Keterangan Usaha Section -->
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Mulai Usaha -->
                        <div>
                            <label for="mulai_usaha" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Tanggal Mulai
                                Usaha *</label>
                            <input type="date" name="mulai_usaha" id="mulai_usaha"
                                value="{{ old('mulai_usaha') }}" required
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                            @error('mulai_usaha')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        ...
                        <!-- Jenis Usaha -->
                        <div>
                            <label for="jenis_usaha" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Jenis Usaha
                                *</label>
                        ...
                        <div class="sm:col-span-2">
                            <label for="alamat_usaha" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Alamat Usaha
                                *</label>
                            <textarea name="alamat_usaha" id="alamat_usaha" rows="3" required
                                placeholder="Alamat lengkap tempat usaha beroperasi"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('alamat_usaha') }}</textarea>
                            @error('alamat_usaha')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="purpose" id="purpose" value="{{ old('purpose') }}"
                                required placeholder="Contoh: Untuk pengajuan kredit, legalisasi usaha, dll"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">
                            @error('purpose')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
