                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <label for="alamat_tujuan" class="block text-sm font-medium text-gray-700">Alamat Tujuan
                                Pindah *</label>
                            <textarea name="alamat_tujuan" id="alamat_tujuan" rows="3" required
                                ...
                                class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">{{ old('alamat_tujuan') }}</textarea>
                            @error('alamat_tujuan')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <!-- Alasan Pindah -->
                        <div class="sm:col-span-2">
                            <label for="alasan_pindah" class="block text-sm font-medium text-gray-700">Alasan Pindah
                                *</label>
                        ...
                        <!-- Tanggal Pindah -->
                        <div>
                            <label for="tanggal_pindah" class="block text-sm font-medium text-gray-700">Tanggal
