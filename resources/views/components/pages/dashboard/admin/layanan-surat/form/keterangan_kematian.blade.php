        ...
        <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
            <form action="{{ route(auth()->user()->role . '.layanan-surat.submit', $type) }}" method="POST"
                ...
                <div class="px-6 pb-4">
                    ...
                    <div class="mt-6">
                        <label for="hubungan_almarhum" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Hubungan dengan
                            Almarhum *</label>
                ...
                <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-600">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-white">Detail Kematian</h3>
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-300">Informasi khusus tentang almarhum/almarhumah</p>
                </div>
                ...
                <div class="px-6 pb-4">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        <!-- Nama Almarhum -->
                        <div>
                            <label for="nama_almarhum" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Nama
                        ...
                        <!-- NIK Almarhum -->
                        <div>
                            <label for="nik_almarhum" class="block text-sm font-medium text-gray-700 dark:text-gray-200">NIK
                                Almarhum/Almarhumah *</label>
                        ...
                        <div>
                            <label for="jenis_kelamin_almarhum" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Jenis
                                Kelamin
                                Almarhum/Almarhumah *</label>
                        ...
                        <!-- Alamat Almarhum -->
                        <div>
                            <label for="alamat_almarhum" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Alamat
                                Almarhum/Almarhumah *</label>
                            <textarea name="alamat_almarhum" id="alamat_almarhum" rows="2" required
                                placeholder="Alamat terakhir almarhum/almarhumah"
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('alamat_almarhum') }}</textarea>
                        ...
                        <!-- Umur Almarhum -->
                        <div>
                            <label for="umur" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Umur
                                Almarhum/Almarhumah *</label>
                        ...
                        <!-- Hari Kematian -->
                        <div>
                            <label for="hari_kematian" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Hari Kematian
                                *</label>
                        ...
                        <!-- Tanggal Kematian -->
                        <div>
                            <label for="tanggal_kematian" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Tanggal
                                Kematian *</label>
                        ...
                        <!-- Tempat Kematian -->
                        <div>
                            <label for="tempat_kematian" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Tempat
                                Kematian *</label>
                        ...
                        <div class="sm:col-span-2">
                            <label for="penyebab_kematian" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Penyebab
                                Kematian
                                *</label>
                            <textarea name="penyebab_kematian" id="penyebab_kematian" rows="3" required
                                ...
                                class="mt-1 block w-full border-gray-300 dark:border-gray-600 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm bg-white dark:bg-gray-700 text-gray-900 dark:text-white">{{ old('penyebab_kematian') }}</textarea>
                        ...
                        <!-- Hubungan Pelapor -->
                        <div class="sm:col-span-2">
                            <label for="hubungan_pelapor" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Hubungan
                                Pelapor dengan
                                Almarhum *</label>
                ...
                <div class="px-6 pb-6">
                    <div class="grid grid-cols-1 gap-6">
                        <!-- Keperluan -->
                        <div>
                            <label for="keperluan" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Keperluan/Tujuan
                                Pengajuan *</label>
